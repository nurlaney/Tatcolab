...
@include('backend.forms.lng_selector', ['lngs'=>$lngs])
        <form action="{{route('admin.categories.update',[$categoriesL[0]->u_id])}}" enctype="multipart/form-data" file="true" method="post" class="form-horizontal form-label-left">
            @csrf
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('admin.categories'), __('buttons.general.cancel')) }}
                </div><!--col-->
